describe("BONUS", () => {
    ...
    describe("Bonus: Iteration 5 | Age at Inauguration", () => {
        ...
        it("should return an array of objects", () => {
            ...
            expect(getAgeAtInauguration(testPresidents)[0]).toEqual(jasmine.any(Object));
        });
        ...
        it("should return an array of objects with the new property 'ageAtInauguration'", () => {
            ...
            testPresidents.forEach((president, index) => {
                ...
                expect(updatedPresident.ageAtInauguration).toEqual(president.tookOffice - president.birthYear);
            });
        });
    });
    ...
    describe("Bonus: Iteration 6 | Presidents Born After", () => {
        ...
        it("should return an array of objects", () => {
            ...
            expect(getPresidentsBornAfter(testPresidents, 1900)).toEqual(jasmine.any(Array));
            expect(getPresidentsBornAfter(testPresidents, 1900)[0]).toEqual(jasmine.any(Object));
        });
    ...
    describe("Bonus: Iteration 8 | Sort Presidents by Name", () => {
        ...
        it("should use the 'sort()' method to sort the presidents array", () => {
            const testPresidents = [{ name: "George Washington" }, { name: "John Adams" }, { name: "George H. W. Bush" }, { name: "Bill Clinton" }, { name: "Barack Obama" }];
