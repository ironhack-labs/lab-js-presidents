...
function getNames(presidentsArr) {
  return (presidentName = presidentsArr.map(
    (eachPresident) => eachPresident.name
  ));
}
...
function getDemocraticPresidents(presidentsArr) {
  return (democraticPresidents = presidentsArr.filter(
...
function countYearsInOffice(presidentsArr) {
  return (sumYears = presidentsArr.reduce((acc, cur) => {
    if (cur.leftOffice) {
