...
function getNames(presidentsArr) {
  // TODO: return an array of all president names
...
function getDemocraticPresidents(presidentsArr) {
  // TODO: return an array of all Democratic presidents
...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((totalYears, president) => {
    const leftOfficeYear = president.leftOffice ?? 2021;
    return totalYears + (leftOfficeYear - president.tookOffice);
  }, 0);
}
...
function countRepublicanPresidents(presidentsArr) {
  return presidentsArr.filter(
    (president) => president.politicalParty === "Republican"
  ).length;
}
