...
function getNames(presidentsArr) {
  const onlyNames = presidentsArr.map((element) => {
    return element.name;
  });
  return onlyNames;
}
...
function getDemocraticPresidents(presidentsArr) {
  // const democraticPresidents = presidentsArr.filter((pres) => {
...
function sortPresidentsByBirthYear(presidentsArr) {
  const oldestPresident = presidentsArr.sort((a, b) => {
    return a.birthYear - b.birthYear;
  });
  return oldestPresident;
}

// Bonus: Iteration 5 | Age at Inauguration - `map()`
function getAgeAtInauguration(presidentsArr) {
  const inaugurationAge = presidentsArr.map((element) => {
