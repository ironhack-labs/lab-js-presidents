...
function getNames(presidentsArr) {
  let presidentsNames = presidentsArr.map((names)=>{
    return names.name
  })
...
function getDemocraticPresidents(presidentsArr) {
  let demPresident = presidentsArr.filter((side)=>{
    return side.party === "Democratic"
  })
  return demPresident
}
...
function getAffiliatedPresidents(presidentsArr) {
  let affPresident = presidentsArr.filter((affiliation)=>{
    return affiliation.party !== null
  })
  return affPresident
}
...
function countRepublicanPresidents(presidentsArr) {
  return presidentsArr.reduce((polSide,president)=>{
