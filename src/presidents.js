...
function getNames(presidentsArr) {
  let presName = presidentsArr.map((president) => {
...
function getAffiliatedPresidents(presidentsArr) {
  ...
  function getAffiliatedPresidents(presidentsArr) {
  let affiliatedPresidents = presidentsArr.filter((president) => {
    return president.party === "Democratic" || president.party === "Whig" || president.party === "Republican" ;
  });
  return affiliatedPresidents; */
...
function countRepublicanPresidents(presidentsArr) {
  let numOfReps = presidentsArr.reduce((acc, cur) => {
...
function sortPresidentsByBirthYear(presidentsArr) {
  let sortingPrez = presidentsArr.sort((a, b) => {
