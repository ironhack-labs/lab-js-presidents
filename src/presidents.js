...
// return presidentsArr.reduce((sumOfYears, currentValue) =>{
//   return president.tookOffice - president.leftOffice
// })}
...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((sumOfYears, currentValue) => {
    if (currentValue.leftOffice !== null) {
      return sumOfYears + (currentValue.leftOffice - currentValue.tookOffice);
    } else {
      return sumOfYears + 0;
    }
  }, 0);
...
// could use a ternary stmt ? president.leftOffice - president.tookOffice + acc
// : sumOfYears,
// 0)
...
//simplified: return presidentsArr.sort((a, b) => a.birthYear - b.birthYear);
...
//spread operator: returns copy of original array but adds inauguration age
// console.log("before map", presidentsArr);
// return presidentsArr.map((president) => {
//   return {
//     ...president,
