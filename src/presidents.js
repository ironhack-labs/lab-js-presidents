...
function getNames(presidentsArr) {
  const names =  presidentsArr.map((t) => {
      return t.name
  })
 return names
}
...
function getDemocraticPresidents(presidentsArr) {
  const names = presidentsArr.filter((t) => {
     return t.party === "Democratic"
  })
  return names
}
...
function  countYearsInOffice(presidentsArr) {
  ...
  total= presidentsArr.reduce((total, president) => {
...
function sortPresidentsByBirthYear(presidentsArr) {
  let sortedArr = presidentsArr.sort((a, b) => {
