...
function getDemocraticPresidents(presidentsArr) {
  let democrPres = presidentsArr.filter((presParty)=>{return presParty.party === "Democratic"})
  console.log(democrPres)
return democrPres
}
...
function getAgeAtInauguration(presidentsArr) {
  return presidentsArr.map((presAge)=>{ 
    return {ageAtInauguration: presAge.tookOffice - presAge.birthYear}  
  })
...
function getPresidentsBornAfter(presidentsArr, year) {
  return presidentsArr.filter((president)=>{return president.birthYear > year})
}
