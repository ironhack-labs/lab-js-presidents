...
const presidentsNamesArr = presidentsArr.map(president => president.name);
...
const democraticPresidentsArr = presidentsArr.filter (president => president.party === "Democratic")

return democraticPresidentsArr
}

// Iteration 3 | Count Years in Office - reduce()
function  countYearsInOffice(presidentsArr) {

const yearsInOffice = presidentsArr.reduce ( (acc,president) => {
...
const presidentsByBirthYearArr = presidentsArr.sort((a, b) => a.birthYear - b.birthYear);

return presidentsByBirthYearArr;
}
...
function getAgeAtInauguration(presidentsArr) {
  ...
  return presidentsArr.map (president => {
    return {
      ...president, // Spread operator to include all existing properties
