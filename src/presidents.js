...
function getNames(presidentsArr) {
	let namePresidents = presidentsArr.map((president) => president.name);
...
function getNamesAndParty(presidentsArr) {
	let namesPartyPresidents = presidentsArr.map(
		(president) => `{ name: ${president.name}, party: ${president.party}}`
	);
	return namesPartyPresidents;
}
...
function getAffiliatedPresidents(presidentsArr) {
	let democraticPresidents = presidentsArr.filter(
		(presidents) => presidents.party != null
	);
	return democraticPresidents;
}
...
function countYearsInOffice(presidentsArr) {
	let allYears = presidentsArr.reduce((acc, currentValue) => {
		if (currentValue.tookOffice != null && currentValue.leftOffice != null) {
...
function sortPresidentsByBirthYear(presidentsArr) {
	let sortPresident = presidentsArr.sort((a, b) => {
