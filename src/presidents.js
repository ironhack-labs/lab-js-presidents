...
function getNamesAndParty(presidentsArr) {
  return presidentsArr.map((presidents) => presidents.name + presidents.party);
}
...
const test = getDemocraticPresidents(presidents);
console.log(test);
...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce(function (accumulator, currentValue) {
...
const test2 = countYearsInOffice(presidents);
console.log(test2);
