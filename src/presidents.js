...
function  countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((totalYears,yearsInOffice) =>{
    return totalYears + ((yearsInOffice.leftOffice ? yearsInOffice.leftOffice : yearsInOffice.tookOffice  ) - yearsInOffice.tookOffice);
  },0)
}
...
function countRepublicanPresidents(presidentsArr){
  return presidentsArr.reduce(function (republicans, president) {
    return republicans = president.party === "Republican" ? republicans+1 : republicans;
  },0)
}
