...
function getNames(presidentsArr) {
  const listPresident = presidentsArr.map((element) => {
    return element.name;
  });
...
function getAgeAtInauguration(presidentsArr) {
  const listPresidentWithAgeAtInauguration = presidentsArr.map((president) => {
  ...
  return listPresidentWithAgeAtInauguration;
}
...
console.log(
  ...
  getPresidentsBornAfter(presidents, 1946)
);
